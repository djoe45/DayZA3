...
class CfgExileCustomCode 
{
	...
	*/
	// ExileClient_object_player_initialize = "TC4\ExileClient_object_player_initialize.sqf";
	ExileClient_system_lootManager_thread_spawn = "Overwrite\ExileClient_system_lootManager_thread_spawn.sqf";
	ExileServer_system_lootManager_network_spawnLootRequest = "exile_server_custom\override\ExileServer_system_lootManager_network_spawnLootRequest.sqf";
};
